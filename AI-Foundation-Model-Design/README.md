...
| [`07-cortex-os-cognitive-architecture.md`](07-cortex-os-cognitive-architecture.md) | **Vio as a Cognitive Operating System (codename CORTEX-OS):** a full engineering spec that redesigns the `mind/` assistant into a digital brain — a Global-Workspace blackboard + 14 cognitive modules (executive, attention, working/semantic/episodic/procedural memory, world model, planner, 8-mode reasoner, confidence, self-critic, curiosity, learning, consolidation), a multi-agent specialist cortex, sparse activation, the sleep-time consolidation loop, energy budgets, phased plan, and folder structure. Runs on a 16–64 GB laptop and **gets smarter with experience, not parameters.** Grounded in the four brain mechanisms already prototyped here |
